    ...
    <main className="min-h-screen flex">
      <div className="hidden md:flex w-1/2 flex-col items-center justify-center p-12"
        ...
        <div className="text-white text-center w-full">
          ...
          <p className="text-lg mb-10 opacity-90">El marketplace de apuntes de la Universidad Autonoma del Peru</p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex rounded-xl overflow-hidden mb-6 border"
            ...
            <button onClick={() => setIsRegister(false)}
              ...
              style={!isRegister ? { backgroundColor: '#EA580C', color: 'white' } : { backgroundColor: 'white', color: '#EA580C' }}>
              Iniciar sesion
            </button>
          ...
          <div className="mb-4">
            ...
            <input type="email" placeholder="correo@autonoma.edu.pe"
              value={email} onChange={(e) => setEmail(e.target.value)}
              className="w-full border border-gray-300 rounded-xl p-3 text-sm focus:outline-none bg-white text-gray-800" />
          </div>
